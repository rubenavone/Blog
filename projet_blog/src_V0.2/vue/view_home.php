...
ob_start();
?>
<header class=" lg:h-header-home h-72 bg-blue-800 text-center presentation">
...
<div class="relative">
<iconify-icon icon="material-symbols:arrow-back-ios-new" class="left-arrow arrow"></iconify-icon>
  <iconify-icon icon="material-symbols:arrow-forward-ios" class="right-arrow arrow"></iconify-icon>
...
<section class="flex flex-col w-full lg:flex-row lg:h-[60vh]">
    ...
    <img src="./dist/img/firmbee-com-gcsNOsPEXfs-unsplash.jpg" alt="" class="lg:w-2/4 w-4/4 object-cover">
</section>
...
<section class="flex flex-col w-full  lg:flex-row lg:h-section-home">
    ...
    <img src="./dist/img/arjan-de-jong-Sb8_i3Kz_JE-unsplash.jpg" alt="" class="lg:w-2/4 w-4/4 object-cover" >
</section>
<section class="flex flex-col w-full lg:flex-row bg-black text-white lg:h-[100vh]">
    <img src="./dist/img/recha-oktaviani-5tYUk7sZzqc-unsplash.jpg" alt="" class="lg:w-2/4 w-4/4 object-cover">
    <article class="lg:w-2/4 w-4/4 pt-5 flex flex-col justify-center items-center">
...
<section class="lg:h-[91vh] overflow-hidden ">
    <div>
    ...
    <div class="flex flex-col lg:flex-row mt-12 mb-5 lg:mb-[0px] lg:h-70vh ">
        <img src="./dist/img/diego-ph-fIq0tET6llw-unsplash.jpg" alt="" class="h-[50rem] lg:w-2/3 w-4/4 object-cover object-center">
