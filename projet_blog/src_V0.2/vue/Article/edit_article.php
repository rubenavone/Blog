    ...
    <div class="mt-8 mr-10 ml-10 w-full lg:w-2/5">
        <div class="grid grid-cols-1 gap-6">
            ...
            <label for="name-article" class="block">
                ...
                <input type="text" class=" mb-5 rounded-md mt-2 block w-full px-0.5 border-0 border-b-2 border-gray-200 focus:ring-0 focus:border-blue-800" placeholder="Nom de l'article" name="name-article" value="<?= $article_wanted->get_name_art() ?>" />
            </label>
            ...
            <div class="lg:flex justify-between items-center">
                <label for="date-article" class="block">
                    ...
                    <input type="date" class="mt-1 mb-5 form-control block w-4/4 px-3 py-1.5  border-0 border-b-2 text-base font-normal text-gray-700 bg-white bg-clip-padding  border-solid border-gray-300 rounded-md transition ease-in-out m-0 focus:ring-0 focus:text-gray-700 focus:bg-white focus:border-blue-800 focus:outline-none " name="date-article" value="<?= $article_wanted->get_date_art() ?>"">
                </label>
            ...
            <label for="content-art" class="block">
                ...
                <textarea class="mt-2 mb-5 block w-full px-0.5 border-0 border-b-2 border-gray-200 focus:ring-0 focus:border-blue-800 rounded-md" rows="7" name="content-article" value="">
