...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mar. 27 sep. 2022 à 16:46
...
INSERT INTO `article` (`id_art`, `name_art`, `content_art`, `date_art`, `id_type`, `image_art`, `id_util`) VALUES
...
ALTER TABLE `article`
  ...
  ADD CONSTRAINT `article_user_FK` FOREIGN KEY (`id_util`) REFERENCES `utilisateur` (`id_util`) ON DELETE RESTRICT ON UPDATE RESTRICT;
